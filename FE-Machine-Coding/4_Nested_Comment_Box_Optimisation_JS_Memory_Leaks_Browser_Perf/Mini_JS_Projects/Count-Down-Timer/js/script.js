...
// declare the variables here -> global variables
...
class Timer {
    ...
    bindEvents() {
        ...
        this.stop.addEventListener('click', () => {this.onStop()});
        this.reset.addEventListener('click', () => {this.onReset()});
        // this.display.addEventListener('focus', (event) => {this.onInput(event)});
    ...
    startTimer() {
        ...
        this.intervalId = setInterval(()=> {
            ...
            if(this.minutes === 0 && this.seconds === 0) {
                this.onReset();
                // TODO: there is a known issue -> fix the start button activated and stop button deactivated
            }
